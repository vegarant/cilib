% cil_sample_fourier_TV() performs a compressive sensing experiment using a
% Fourier sampling operator and total variation minimization. The Fourier
% operator is a subsampled two-dimensional Fourier transform, while the total
...
%
function [im_rec, z] = cil_sample_fourier_TV(im, noise, idx, filename, varargin);
    ...
    opts.maxintiter = 5;
    opts.TOlVar = 1e-5;
    opts.verbose = opts.nesta_verbose;
    opts.maxiter = 5000;
