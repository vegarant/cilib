...
[idx1, str_id] = cil_sph2_DAS_randy(N, nbr_samples, sValues);
epsilon2 = .1;
sparsities2 = cil_compute_sparsity_of_image(im, vm, nres, epsilon2);
[idx2, str_id] = cil_sph2_DAS(N, nbr_samples, sparsities2);
epsilon3 = .5;
sparsities3 = cil_compute_sparsity_of_image(im, vm, nres, epsilon3);
[idx3, str_id] = cil_sph2_DAS(N, nbr_samples, sparsities3);
epsilon4 = 1;
sparsities4 = cil_compute_sparsity_of_image(im, vm, nres, epsilon4);
[idx4, str_id] = cil_sph2_DAS(N, nbr_samples, sparsities4);
...
fname = sprintf('plots/Patt_had_DAS_N_%d_srate_%02d', N, round(100*subsampling_ratio));
