% This configuration file set all parameters used by `Compute_PSNR_curve_fourier.m`
...
r0 = 2;
nbr_levels = 50; 
f1 = @(N, nbr_samples) cil_spf2_gcircle(N, nbr_samples, a, r0, nbr_levels);
...
r0 = 2;
nbr_levels = 50; 
f2 = @(N, nbr_samples) cil_spf2_gcircle(N, nbr_samples, a, r0, nbr_levels);
...
r0 = 2;
nbr_levels = 50; 
f3 = @(N, nbr_samples) cil_spf2_gdiamond(N, nbr_samples, a, r0, nbr_levels);
...
r0 = 2;
nbr_levels = 50; 
f4 = @(N, nbr_samples) cil_spf2_gdiamond(N, nbr_samples, a, r0, nbr_levels);
