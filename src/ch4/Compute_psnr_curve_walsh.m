...
% It performs a series of Walsh sampling and wavelet reconstruction experiments with 
...
config_name = fullfile(dest_data_full, 'config_psnr_walsh.m');
copyfile('config_psnr_walsh.m', config_name);
run(config_name);
...
for i_patt = 1:nbr_of_patterns;
    ...
    for j = 1:nbr_of_srates    
        ...
        [im_rec, z] = cil_sample_walsh_wavelet(im, noise_level, idx, fname, ...
